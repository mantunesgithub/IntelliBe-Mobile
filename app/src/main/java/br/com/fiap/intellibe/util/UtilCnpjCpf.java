package br.com.fiap.intellibe.util;
 ...
 */
public class UtilCnpjCpf {

    private static final String VALUE_CANNOT_BE_NULL = "Valor não pode ser nulo";
    private static final String VALUE_CANNOT_BE_NULL_OR_EMPTY
            = "Valor não pode ser nulo ou vazio";
    private static final String SIZE_OF_VALUE_CANNOT_BE_BIGGER_THEN_14
            = "Tamanho do valor não pode ser maior que 14";
    private static final String VALUE_IS_NOT_A_VALID_CPF_OR_CPNJ
            = "valor não é CPF ou CNPJ válido";
    ...
    /**
     * Formata valor para numerico
     *
     * @param value [string] representa um numero formatado ex: CPF ou CNPJ
     * @return Long CPF ou CNPJ
     */
    public static Long formatCPForCPNJ(String value) {
